We need the base chrome components that frame every editor screen - the top navbr and the left sidebar shell. These will be reused and extended in every chapter that follows.
